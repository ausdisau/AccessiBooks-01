...
- Name: account-settings.e2e.spec.ts >> Account & Settings page — Free user (real auth) >> renders the ad-preference toggles, NOT the ad-free message
- Location: tests/account-settings.e2e.spec.ts:89:3
