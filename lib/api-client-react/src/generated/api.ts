...
/**
 * @summary Get the currently authenticated Replit Auth user
 */
export const getGetCurrentAuthUserUrl = () => {
  return `/api/replit-auth/user`;
};
...
export const getGetCurrentAuthUserQueryKey = () => {
  return [`/api/replit-auth/user`] as const;
};
...
export const getBeginBrowserLoginUrl = (params?: BeginBrowserLoginParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/replit-auth/login?${stringifiedParams}`
    : `/api/replit-auth/login`;
};
...
export const getBeginBrowserLoginQueryKey = (
  ...
  return [`/api/replit-auth/login`, ...(params ? [params] : [])] as const;
};
...
export const getHandleBrowserLoginCallbackUrl = (
  ...
  return stringifiedParams.length > 0
    ? `/api/replit-auth/callback?${stringifiedParams}`
    : `/api/replit-auth/callback`;
};
...
export const getHandleBrowserLoginCallbackQueryKey = (
  ...
  return [`/api/replit-auth/callback`, ...(params ? [params] : [])] as const;
};
...
/**
 * @summary Clear the Replit Auth session and begin OIDC logout
 */
export const getLogoutBrowserSessionUrl = () => {
  return `/api/replit-auth/logout`;
};
...
export const getLogoutBrowserSessionQueryKey = () => {
  return [`/api/replit-auth/logout`] as const;
};
...
export const getExchangeMobileAuthorizationCodeUrl = () => {
  return `/api/replit-auth/mobile-auth/token-exchange`;
};
...
export const getLogoutMobileSessionUrl = () => {
  return `/api/replit-auth/mobile-auth/logout`;
};
