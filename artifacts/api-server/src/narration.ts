...
// Abuse / cost controls.
// ---------------------------------------------------------------------------
const MAX_TOTAL_CHARS = 600_000; // ~hard cap on book text we will synthesize
const MAX_CHAPTERS = 60; // cap chapters per book
const CHARS_PER_SYNTHETIC_CHAPTER = 9_000; // when no headings are detected
const TTS_SUBCHUNK_CHARS = 2_500; // ElevenLabs safe per-request size
