...
CREATE TABLE "push_subscriptions" (
	...
	"auth" text NOT NULL,
	"enabled_types" text[] DEFAULT ARRAY['streak_reminder','goal_nudge','new_content','achievement','recommendation','re_engagement','author_update','system']::text[] NOT NULL,
	"created_at" timestamp DEFAULT now(),
...
CREATE INDEX "idx_vpp_pack" ON "voice_pack_purchases" USING btree ("voice_pack_id");